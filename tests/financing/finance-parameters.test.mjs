...
const { FINANCE_PARAMETER_CONFIG, financeParameterPayload, financialReconciliation, financialValue, monthEnd } = await tsImport('../../src/lib/financing/finance-parameters.ts', import.meta.url);
