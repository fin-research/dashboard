...
test('desktop news detail recovers and shows structured content',async({page})=>{
  ...
  await expect(page).toHaveScreenshot('news-detail-desktop.png',{fullPage:true});
...
test('desktop research detail shows its body and related policies',async({page})=>{
  ...
  await expect(page).toHaveScreenshot('article-detail-desktop.png',{fullPage:true});
});
...
test('desktop commentary detail wraps titles and centers standalone reports',async({page})=>{
  ...
  await expect(page).toHaveScreenshot('commentary-detail-desktop.png',{fullPage:true});
  ...
  await expect(page).toHaveScreenshot('commentary-standalone-desktop.png',{fullPage:true});
});
