...
export const assistantCustomers=[
  {name:'测试银行甲',confidentialityStatus:true,reportDate:today},
  {name:'测试银行乙',confidentialityStatus:false,reportDate:today},
];
export const assistantSession={turns:[{id:'audit-turn',question:'请核实公司流动性指标，并列出计算依据及需补充确认的事项。',createdAt:`${today}T03:00:00Z`,answer:{status:'partial',paragraphs:[{text:'截至报告期末，公司流动性覆盖率为180%，净稳定资金率为125%，均高于相应监管标准。',citations:[{sourceId:'audit-source',quote:'期末流动性覆盖率为180%，净稳定资金率为125%。'}]}],gaps:['最新月份的流动性指标尚待业务部门确认。'],attachments:[],sources:[{id:'audit-source',documentId:'audit-doc',locator:'第12页',title:'测试公司2026年半年度报告',authority:'disclosure',url:'/audit-document.pdf',extraction:'text'}],calculations:[],files:[],corpusVersion:'fixture',createdAt:`${today}T03:00:00Z`,warnings:[],disclosure:{policyVersion:1,institutionName:'测试银行甲',documentIds:['audit-doc'],blocked:false}}}],running:false,progress:'',error:null,startedAt:0,customer:assistantCustomers[0]};
